    ...
    <div className="services">
      ...
      {/* <div className="howWeWork">
        <div className="how-title">
          ...
          <p>
            Régóta ismert tény, hogy a figyelem könnyen elterelődik. A lenti
            lépésekkel átlátható folyamatot biztosítunk.
          </p>
        </div>
        <div className="how-content">
            ...
            <div className="hc-text">
                ...
                <div className="hc-subtext">
                    <h2>Koncepció és részletek</h2>
                    <p>Átlátható koncepció, pontos részletek, követhető terv a kivitelezéshez. </p>
                </div>
            </div>
        </div>
        ...
        <div className="how-content">
            <div className="hc-text">
                ...
                <div className="hc-subtext">
                    <h2>Ötlet és tervezés</h2>
                    <p>Inspiráló ötletek, praktikus megoldások – az Ön igényeire szabva. </p>
                </div>
            </div>
            <div className="hc-img">
        ...
        <div className="how-content">
            ...
            <div className="hc-text">
                ...
                <div className="hc-subtext">
                    <h2>Design</h2>
                    <p>Esztétika és funkcionalitás kéz a kézben, megvalósítható tervvel. </p>
                </div>
            </div>
        </div>
        ...
        <div className="how-content">
            <div className="hc-text">
                ...
                <div className="hc-subtext">
                    <h2>Precizitás</h2>
                    <p>Minőségi kivitelezés, részletekbe menő odafigyeléssel. </p>
                </div>
            </div>
            <div className="hc-img">
